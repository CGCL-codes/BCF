...
extern size_t NumberOfBuckets_4;
extern size_t NumberOfBuckets_3;
extern size_t NumberOfBuckets_2;
extern size_t NumberOfBuckets_1;
extern size_t NumberOfBuckets_0;
extern size_t NumberOfRelocations;
...
const size_t kMaxCuckooCount = 1000;
...
Status CuckooFilter<ItemType, bits_per_item, TableType, HashFamily>::AddImpl(
  ...
  for (uint32_t count = 0; count < kMaxCuckooCount; count++) {
    ...
    if (table_->InsertTagToBucket(curindex, curtag, kickout, oldtag)) {
      switch(table_->NumTagsInBucket(curindex)-1){
        case 3:
          NumberOfBuckets_3=NumberOfBuckets_3>0?NumberOfBuckets_3-1:0;
          NumberOfBuckets_4++;
          break;
        case 2:
          NumberOfBuckets_2=NumberOfBuckets_2>0?NumberOfBuckets_2-1:0;
          NumberOfBuckets_3++;
          break;
        case 1:
          NumberOfBuckets_1=NumberOfBuckets_1>0?NumberOfBuckets_1-1:0;
          NumberOfBuckets_2++;
          break;
        case 0:
          NumberOfBuckets_0=NumberOfBuckets_0>0?NumberOfBuckets_0-1:0;
          NumberOfBuckets_1++;

      }
      num_items_++;
      NumberOfRelocations=count;
      return Ok;
    }
    if (kickout) {
      curtag = oldtag;
    ...
    curindex = AltIndex(curindex, curtag);
     if(count==kMaxCuckooCount-1){
      
      NumberOfRelocations=kMaxCuckooCount;
      return InsertFail;
